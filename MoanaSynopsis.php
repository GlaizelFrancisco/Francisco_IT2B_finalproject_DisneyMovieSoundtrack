...
<style type="text/css">
    ...
    body{ background: linear-gradient(to right, #d7473a, #e0b896);
     }
...
<div class="row">
  <div class="column" style="background-color:transparent; height: auto;">
    ...
    <h3>Summaries</h3>
    <?php
    echo "<p> In Ancient Polynesia, when a terrible curse incurred by the Demigod Maui reaches Moana's island, she answers the Ocean's call to seek out the Demigod to set things right.</p>";
