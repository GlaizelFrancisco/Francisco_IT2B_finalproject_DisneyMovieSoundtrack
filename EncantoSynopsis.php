...
<div class="row">
  <div class="column" style="background-color:transparent; height: auto;">
    <img src="images/Synopsis/Encanto.jpeg" style="padding-top: 10px ; padding-left: 10px;" width="500" height="250"></a> 
    <a href= "https://loklok.com/detail/0/9705"
    style="text-decoration: none; color:blue; font-weight: bold; font-size: 30px; padding-left:  25px;" >Encanto</a>
    
    <h3>Summaries</h3>
    <?php
    echo "<p> A Colombian teenage girl has to face the frustration of being the only member of her family without magical powers.</p>";
     
    echo "<p> Encanto tells the tale of an extraordinary family, the Madrigals, who live hidden in the mountains of Colombia, in a magical house, in a vibrant town, in a wondrous, charmed place called an Encanto. The magic of the Encanto has blessed every child in the family with a unique gift from super strength to the power to heal-every child except one, Mirabel. But when she discovers that the magic surrounding the Encanto is in danger, Mirabel decides that she, the only ordinary Madrigal, might just be her exceptional family's last hope.—Walt Disney Animation Studios</p>";

    echo "<p> The Madrigals are an extraordinary family who live hidden in the mountains of Colombia in a charmed place called the Encanto. The magic of the Encanto has blessed every child in the family with a unique gift -- every child except Mirabel. However, she soon may be the Madrigals' last hope when she discovers that the magic surrounding the Encanto is now in danger.—anonymous</p>";

    echo "<p> Blessed to live in a secret, enchanted haven, the exceptional Madrigal family has found shelter in the bosom of a secured, mountainous realm in Colombia brimming with colour and kindness. However, as the mystical power of an inconspicuous artefact bestows its residents with supernatural gifts, introspective teen Mirabel has yet to receive her distinct talent. But when an unpredictable, terrible crisis puts the future of the tight-knit community in jeopardy, it is up to Mirabel to step up and try to save the day. Can the unlikely defender protect the family and find her true calling?—Nick Riganas</p>";
